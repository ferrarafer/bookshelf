...
// in bookshelf/test/helpers/test_helpers.dart.
...
import 'package:bookshelf/services/api_service.dart' as _i6;
...
class MockApiService extends _i1.Mock implements _i6.ApiService {
  @override
  _i4.Future<List<_i7.Book>> getBooks({String? searchTerm = r'computers'}) =>
      (super.noSuchMethod(
        Invocation.method(
          #getBooks,
          [],
